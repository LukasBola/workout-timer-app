...
describe('presetService', () => {
  ...
  describe('createPreset', () => {
    it('creates a preset with correct fields', () => {
      const dto = { name: 'HIIT', workoutDuration: 30, breakDuration: 10, rounds: 8 };
    ...
    it('trims whitespace from name', () => {
      const preset = presetService.createPreset({ name: '  Tabata  ', workoutDuration: 20, breakDuration: 10, rounds: 8 });
      createdIds.push(preset.id);
  ...
  describe('getAllPresets', () => {
    it('returns all created presets', () => {
      ...
      const p1 = presetService.createPreset({ name: 'A', workoutDuration: 10, breakDuration: 5, rounds: 3 });
      const p2 = presetService.createPreset({ name: 'B', workoutDuration: 20, breakDuration: 10, rounds: 5 });
  ...
  describe('getPresetById', () => {
    it('returns the correct preset', () => {
      const p = presetService.createPreset({ name: 'Test', workoutDuration: 15, breakDuration: 5, rounds: 4 });
  ...
  describe('deletePreset', () => {
    it('deletes an existing preset', () => {
      const p = presetService.createPreset({ name: 'Delete me', workoutDuration: 10, breakDuration: 5, rounds: 2 });
